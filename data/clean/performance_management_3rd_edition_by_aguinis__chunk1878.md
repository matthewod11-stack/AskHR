...
pages: n/a-n/a
chunk_id: e3a8997c048d0540350d4ae9d04e553d93a0fbce
...
- 3. Define measurement goals clearly. Defining how the data will be used (e.g., administrative vs. developmental purposes, or both) is a decision that must be made before measures of team performance are designed. As is the case with individual-level data discussed throughout the book, there are different variables that must be taken into account in relationship to the measures’ purpose (e.g., what will be the sources of data, how data will be collected, and so forth).
